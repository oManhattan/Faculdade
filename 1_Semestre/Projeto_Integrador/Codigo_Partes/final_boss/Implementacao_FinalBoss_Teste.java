 ...
 * @author Matheus
 */
public class Implementacao_FinalBoss_Teste {

    public static void main(String[] args) {
        int[] status = {100, 2}; // Health Points, potions

        status = ExecutaFinalBoss(status);
    }
    ...
    static int[] ExecutaFinalBoss(int[] status) {
        ...
        System.out.print("\nAperte ENETER para voltar ao Menu");
        sc.nextLine();
        System.out.println(" ");
        return status;
    }
